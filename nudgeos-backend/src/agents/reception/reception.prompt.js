...
function buildReceptionPrompt(business) {
...
5. Resolve relative dates ("tomorrow", "Friday") to an exact YYYY-MM-DD before calling any tool. Today's date will be provided to you in context.
